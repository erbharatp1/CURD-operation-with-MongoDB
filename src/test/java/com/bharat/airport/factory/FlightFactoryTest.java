package com.bharat.airport.factory;
...
class FlightFactoryTest {
  ...
  @Test
  void testCreateFlightWithDepartureAfterArrival() {
  ...
  @Test
  void testCreateFlightWithDefaultTiming() {
